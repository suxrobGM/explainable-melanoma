...
\begin{table}[t]
    ...
    % scripts/eval.py; fill in after regenerating with saved probabilities.
\end{table}
...
\begin{table}[t]
    ...
    \begin{tabular}{lccccr}
        ...
        \bottomrule
    \end{tabular}
    % Specificity and per-class AUC produced by scripts/eval.py from saved
...
% Numbers produced by scripts/eval_faithfulness.py; fill in after the run.
