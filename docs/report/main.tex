...
\textbf{Epistemic Uncertainty} measures model uncertainty arising from limited training data:
\begin{equation}
...
\textbf{Aleatoric Uncertainty} captures inherent data noise that cannot be reduced:
\begin{equation}
