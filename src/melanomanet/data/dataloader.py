...
def prepare_isic2019_labels(data_dir: str) -> pd.DataFrame:
    """
    Prepare ISIC2019 labels DataFrame.
    ...
    CSV format: image,MEL,NV,BCC,AK,BKL,DF,VASC,SCC
    Where MEL=1 indicates melanoma
    ...
    # Binary classification: Melanoma (MEL) vs Everything else
    ...
    print(f"Melanoma prevalence: {df['target'].mean()*100:.2f}%")
...
def create_data_loaders(
    ...
    class_weights = get_class_weights(labels_df)
